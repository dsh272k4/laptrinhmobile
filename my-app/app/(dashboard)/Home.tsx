...
const Dashboard = () => {
  ...
  const fetchRevenue = async () => {
    try {
      const response = await axios.get('http://192.168.11.23:8080/api/orders/revenue');
  ...
  const fetchTotalOrders = async () => {
    try {
      const response = await fetch('http://192.168.11.23:8080/api/orders/total');
      if (response.ok) {
  ...
  const fetchTotalUser = async () => {
    try {
      const response = await fetch('http://192.168.11.23:8080/api/users/count-today');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchTotalSuccessfulOrders = async () => {
    try {
      const response = await fetch('http://192.168.11.23:8080/api/orders/total-successful');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchTotalProduct = async () => {
    try {
      const response = await fetch('http://192.168.11.23:8080/api/products/count');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchTotalProductDay = async () => {
    try {
      const response = await fetch('http://192.168.11.23:8080/api/count-today');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchOrders = async () => {
    try {
      const response = await axios.get('http://192.168.11.23:8080/api/orders');
  ...
  const fetchWeeklyRevenue = async (year: number, month: number) => {
    try {
      const response = await axios.get('http://192.168.11.23:8080/api/revenue-by-week', {
        params: { year, month },
      });
